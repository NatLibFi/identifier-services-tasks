...
export default function (agenda) {
  ...
  async function create(request, type, subtype) {
    ...
    if (type === 'publications') {
      const publication = await createPublisher({...request, publisher: {...request.publisher, publisherType: request.publisherType ? request.publisherType : 'A', selfPublisher: false, publicationPublisher: true}});
