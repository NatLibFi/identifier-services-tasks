...
export const MELINDA_STATE = readEnvironmentVariable('MELINDA_STATE', {defaultValue: ['pending', 'inProgress']});
export const MELINDA_JOB_TYPE = readEnvironmentVariable('MELINDA_JOB_TYPE', {defaultValue: ['isbn-ismn', 'issn']});
