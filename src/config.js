...
export const JOB_PUBLICATION_ISBN_ISMN_BIBLIOGRAPHIC_METADATA_PENDING = 'JOB_PUBLICATION_ISBN_ISMN_BIBLIOGRAPHIC_METADATA_PENDING';
export const JOB_PUBLICATION_ISBN_ISMN_BIBLIOGRAPHIC_METADATA_INPROGRESS = 'JOB_PUBLICATION_ISBN_ISMN_BIBLIOGRAPHIC_METADATA_INPROGRESS';
export const JOB_PUBLICATION_ISSN_BIBLIOGRAPHIC_METADATA_PENDING = 'JOB_PUBLICATION_ISSN_BIBLIOGRAPHIC_METADATA_PENDING';
export const JOB_PUBLICATION_ISSN_BIBLIOGRAPHIC_METADATA_INPROGRESS = 'JOB_PUBLICATION_ISSN_BIBLIOGRAPHIC_METADATA_INPROGRESS';

export const JOB_REQUEST_BG_PROCESSING_CLEANUP_USERS = 'JOB_REQUEST_BG_PROCESSING_CLEANUP_USERS';
export const JOB_REQUEST_BG_PROCESSING_CLEANUP_PUBLISHERS = 'JOB_REQUEST_BG_PROCESSING_CLEANUP_PUBLISHERS';
export const JOB_REQUEST_BG_PROCESSING_CLEANUP_ISBN_ISMN = 'JOB_REQUEST_BG_PROCESSING_CLEANUP_ISBN_ISMN';
...
export const JOBS = readEnvironmentVariable('JOBS', {
	defaultValue: [
		{jobFreq: JOB_FREQ_PENDING, jobName: JOB_PUBLICATION_ISBN_ISMN_BIBLIOGRAPHIC_METADATA_PENDING},
		{jobFreq: JOB_FREQ_IN_PROGRESS, jobName: JOB_PUBLICATION_ISBN_ISMN_BIBLIOGRAPHIC_METADATA_INPROGRESS},
		{jobFreq: JOB_FREQ_PENDING, jobName: JOB_PUBLICATION_ISSN_BIBLIOGRAPHIC_METADATA_PENDING},
		{jobFreq: JOB_FREQ_IN_PROGRESS, jobName: JOB_PUBLICATION_ISSN_BIBLIOGRAPHIC_METADATA_INPROGRESS},
		{jobFreq: REQUEST_TTL, jobName: JOB_REQUEST_BG_PROCESSING_CLEANUP_USERS},
		{jobFreq: REQUEST_TTL, jobName: JOB_REQUEST_BG_PROCESSING_CLEANUP_PUBLISHERS},
		{jobFreq: REQUEST_TTL, jobName: JOB_REQUEST_BG_PROCESSING_CLEANUP_ISBN_ISMN},
		{jobFreq: REQUEST_TTL, jobName: JOB_REQUEST_BG_PROCESSING_CLEANUP_ISSN},
		{jobFreq: JOB_FREQ_REQUEST_STATE_NEW, jobName: JOB_USER_REQUEST_STATE_NEW},
		{jobFreq: JOB_FREQ_REQUEST_STATE_ACCEPTED, jobName: JOB_USER_REQUEST_STATE_ACCEPTED},
		{jobFreq: JOB_FREQ_REQUEST_STATE_REJECTED, jobName: JOB_USER_REQUEST_STATE_REJECTED},
		{jobFreq: JOB_FREQ_REQUEST_STATE_NEW, jobName: JOB_PUBLISHER_REQUEST_STATE_NEW},
		{jobFreq: JOB_FREQ_REQUEST_STATE_ACCEPTED, jobName: JOB_PUBLISHER_REQUEST_STATE_ACCEPTED},
		{jobFreq: JOB_FREQ_REQUEST_STATE_REJECTED, jobName: JOB_PUBLISHER_REQUEST_STATE_REJECTED},
		{jobFreq: JOB_FREQ_REQUEST_STATE_NEW, jobName: JOB_PUBLICATION_ISSN_REQUEST_STATE_NEW},
		{jobFreq: JOB_FREQ_REQUEST_STATE_ACCEPTED, jobName: JOB_PUBLICATION_ISSN_REQUEST_STATE_ACCEPTED},
		{jobFreq: JOB_FREQ_REQUEST_STATE_REJECTED, jobName: JOB_PUBLICATION_ISSN_REQUEST_STATE_REJECTED},
		{jobFreq: JOB_FREQ_REQUEST_STATE_NEW, jobName: JOB_PUBLICATION_ISBNISMN_REQUEST_STATE_NEW},
		{jobFreq: JOB_FREQ_REQUEST_STATE_ACCEPTED, jobName: JOB_PUBLICATION_ISBNISMN_REQUEST_STATE_ACCEPTED},
		{jobFreq: JOB_FREQ_REQUEST_STATE_REJECTED, jobName: JOB_PUBLICATION_ISBNISMN_REQUEST_STATE_REJECTED}
	]
});
